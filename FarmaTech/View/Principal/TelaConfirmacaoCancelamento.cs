...
{
    public partial class TelaConfirmacaoCancelamento : Form
    {
        public TelaConfirmacaoCancelamento()
        {
            InitializeComponent();
        }
        ...
        private void TelaConfirmacaoCancelamento_Paint(object sender, PaintEventArgs e)
        {
