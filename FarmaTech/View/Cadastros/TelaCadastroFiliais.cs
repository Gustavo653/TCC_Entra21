...
namespace FarmaTech.View
{
    public partial class TelaCadastroFiliais : Form
    {
        ...
        {
            int resultado = BAL.Control.CRUD_Enderecos_BAL.AdicionarEndereco(Convert.ToInt32(DAL.Model.Enums.Enderecos.Filiais), txtRazaoSocial.Text, txtNomeFantasia.Text, txtCnpj.Text, txtContato.Text, txtEndereco.Text, txtNumero.Text, txtCompl.Text, txtCidade.Text, cboEstados.Text);
        ...
        public void AtualizaDG()
        {
            ...
            {
                List<DAL.Model.Objetos.Endereco> lista = BAL.Control.CRUD_Enderecos_BAL.GetEnderecoPorNome(Convert.ToInt32(DAL.Model.Enums.Enderecos.Filiais), txtPesquisaUsuario.Text);
                dgUsuarios.DataSource = lista;
            }
            else
            {
                List<DAL.Model.Objetos.Endereco> lista = BAL.Control.CRUD_Enderecos_BAL.GetEndereco(Convert.ToInt32(DAL.Model.Enums.Enderecos.Filiais));
                dgUsuarios.DataSource = lista;
            }
        }
